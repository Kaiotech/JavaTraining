...
public class HashSetOperationsApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("All the least reliable car brands available in our dealership: " + carBrands.containsAll(leastReliableCarBrands));
//        carBrands.retainAll(leastReliableCarBrands);
//        System.out.println("The least reliable car brands: " + carBrands);
