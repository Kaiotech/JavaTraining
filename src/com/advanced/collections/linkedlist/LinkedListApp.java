...
//        morningRoutine.add("Doing 32 push-ups");
        ...
        morningRoutine.offer("Reading 1 chapter of my book.");

   //     System.out.println("I used pop function here but idk why: " + morningRoutine.pop());


        System.out.println(morningRoutine);

        System.out.println("I completed the first elements: " + morningRoutine.pollFirst());
        System.out.println("I completed the last elements: " + morningRoutine.pollLast());
