...
public class AthleteApp {
    public static void main(String[] args) {
        BasketballPlayer kobe = new BasketballPlayer("Kobe Bryant", "Black Mamba", 1978, "Lakers", 73.7, 25.0, 1346);
        ...
        Swimmer katinka = new Swimmer("Katinka Hosszú", "Iron Lady", 1989, "Team Iron", 542, 845);
        System.out.println("-------------------------------------");
        katinka.compete();
